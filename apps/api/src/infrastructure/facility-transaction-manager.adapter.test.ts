...
describe(
  ...
  () => {
    ...
    it(
      'runs durable compensations in reverse registration order',
      async () => {
        const fixture =
          createFixture();
    ...
    it(
      'returns a completed idempotent replay without creating another journal',
      async () => {
        const fixture =
          createFixture({
            id:
