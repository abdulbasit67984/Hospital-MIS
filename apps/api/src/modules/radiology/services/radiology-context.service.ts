...
import {
  ...
  RadiologyEncounterNotActiveError,
  RadiologyOrderingProviderNotAssignedError,
...
function mismatch(
  ...
  throw new RadiologyClinicalContextMismatchError(message);
}

export class RadiologyContextService
implements RadiologyClinicalContextPort {
  public constructor(
  ...
  public async resolveActiveEncounter(
    ...
    if (
      ...
      throw new RadiologyEncounterNotActiveError();
    }
    ...
    if (encounter.opdVisitId !== null) {
      ...
      if (
        ...
        mismatch(
          'The OPD visit is not eligible for Radiology ordering',
        );
      }
  ...
  public assertOrderingProviderAssigned(
    ...
    if (!context.assignedProviderIds.includes(orderingProviderId)) {
      throw new RadiologyOrderingProviderNotAssignedError();
    }
  }
}