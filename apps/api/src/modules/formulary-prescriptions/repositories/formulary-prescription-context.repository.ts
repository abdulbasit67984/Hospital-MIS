...
export interface FormularyPrescriptionEncounterContextRecord {
  id: string;
  facilityId: string;
  patientId: string;
...
export interface FormularyPrescriptionActorIdentityRecord {
  userId: string;
...
export class FormularyPrescriptionContextRepository {
  public async findEncounter(
    facilityId: string,
    encounterId: string,
  ): Promise<FormularyPrescriptionEncounterContextRecord | null> {
    const record =
    ...
    const record =
      await UserModel.findById(
        ...
        .lean<{
          ...
          status:
            FormularyPrescriptionActorIdentityRecord['status'];
        }>()
        .exec();
